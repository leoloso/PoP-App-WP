...
IS_WP_ALREADY_INSTALLED=$(cat .temp) && ./vendor/leoloso/pop-api-wp/install/post-maybe-install-wp.sh $IS_WP_ALREADY_INSTALLED

# Maybe show footer
./vendor/leoloso/pop-api-wp/install/maybe-print-footer.sh $IS_WP_ALREADY_INSTALLED
